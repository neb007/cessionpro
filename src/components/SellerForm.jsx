...
import { X, Plus, Save, Send, Loader2, Building2, Eye, Info, ChevronLeft, ChevronRight, BarChart3, Target, Camera } from 'lucide-react';
...
export default function SellerForm({
  ...
  useEffect(() => {
    if (formData.country === 'france' && formData.location && !formData.region) {
      ...
      if (detectedRegion) {
        onFormChange({ ...formData, region: detectedRegion });
      }
    }
  ...
  useEffect(() => {
    console.debug('[completion-indicator-form]', {
      form: 'seller', completionScore, requiredCompletionScore, allRequiredFilled, isHighCompletion
    });
  ...
  const handleChange = (field, value) => {
    ...
    if (field === 'sector' && value) {
      ...
      if (!hasDefaultImage) {
        updatedData.images = [
          { url: defaultImageUrl, isDefault: true },
                    ...
                    <Card className="border-0 shadow-sm">
                      <CardHeader>
                        <CardTitle className="font-display flex items-center gap-2">
                          ...
                          {language === 'fr' ? "L'essentiel" : 'Essential Information'}
                        </CardTitle>
                      </CardHeader>
                    ...
                    <Card className="border-0 shadow-sm">
                      <CardHeader>
                        <CardTitle className="font-display flex items-center gap-2">
                          ...
                          {language === 'fr' ? 'Chiffres & finances' : 'Figures & Finances'}
                        </CardTitle>
                      </CardHeader>
                ...
                {currentStep === 2 && (
                  <>
                    ...
                    <Card className="border-0 shadow-sm">
                      <CardHeader>
                        <CardTitle className="font-display">
                          {language === 'fr' ? 'Contexte de la cession' : 'Sale Context'}
                        </CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        <div className="grid sm:grid-cols-2 gap-4">
